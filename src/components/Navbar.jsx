               ...
               <div className="grow items-center lg:flex">
                  <ul className="hidden !shrink-0 items-center pl-5 pr-[2.6rem] lg:inline-flex">
                     ...
                     <li className="list-element">
                        <Link className="list-item">Menü</Link>
                     </li>
                     <li className="list-element">
                        <Link className="list-item">Kampanyalar</Link>
                     </li>
                     <li className="list-element">
                        <Link className="list-item">E-Gift</Link>
                     </li>
                     <li className="list-element">
                        <Link className="list-item">KURUMSAL ÇÖZÜMLER</Link>
                     </li>
                  </ul>
